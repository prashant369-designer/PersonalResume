          ...
          <div className="container">
            ...
            <div className="pt-10 xl:pt-16 flex gap-10 items-center justify-between">
              ...
              <div className="w-full lg:max-w-2xl flex-1">
                <p>
                  I thrive on building real-world projects that challenge me and
                  help me grow as a developer. Currently, I’m seeking
                  opportunities in a collaborative and growth-oriented
                  environment where I can apply my skills and contribute
                  meaningfully to impactful products. Let’s connect and build
                  something amazing!
                </p>
